...
NeoPixelRGBWWLightOutput = neopixelbus_ns.class_(
    "NeoPixelRGBWWLightOutput", NeoPixelBusLightOutputBase
)
...
async def to_code(config):
    ...
    if has_white:
        out_type = NeoPixelRGBWWLightOutput.template(method_template)
    else:
